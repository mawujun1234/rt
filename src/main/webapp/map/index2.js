(function() {
	...
	window.init_index = 0;
	$.getJSON("/map/getShopGeoCoord.do", function(result) {
		...
		require([ 'echarts', 'BMap', 'echarts/chart/map' ], 
			...
			option = {
				...
				color : [ 'rgba(255, 255, 255, 0.8)',
						'rgba(14, 241, 242, 0.8)', 'rgba(37, 140, 249, 0.8)' ],
				title : {
...
//								},
						...
						} ,
						{
		                    ...
		                    markLine : {
		                        ...
		                        data : [
		                            [{geoCoord:[121.579006,29.885259]},{geoCoord:[125.133686,42.923303]}],
									[{geoCoord:[121.579006,29.885259]},{geoCoord:[120.305456,31.570037]}],
									[{geoCoord:[121.579006,29.885259]},{geoCoord:[112.935556,27.835095]}],
									[{geoCoord:[121.579006,29.885259]},{geoCoord:[110.487231,31.595768]}]
		                        ]
		                    },
		                    markPoint : {
		                        symbol:'emptyCircle',
...
//		                        },
		                        ...
		                        data : [
		                            //{"name":"绵阳广元西街专卖店","geoCoord":[105.82702295194,32.442479261726],"value":0}
		                        ]
		                    }	
						}],
			...
			// myChart.setOption(option); 
			 ...
			 $.ajax({
			     ...
			     success: function(data) {
			         option.series[2].markLine.data = data.allLine.sort(function (a, b) {
			             return b.num - a.num
			         ...
			         option.series[2].markPoint.data = data.topCityOut.map(function (point) {
			             return {
...
//						myChart.delMarkLine(3,window.markLines[i][0].name+" > "+window.markLines[i][1].name)
//					}
//					window.markLines=[];
